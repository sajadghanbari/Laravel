                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="width-22-rem text-left">
                                <button class="btn btn-warning btn-sm" type="submit"><i class="fa fa-edit"></i> ویژگی ها</button>
                                <button class="btn btn-primary btn-sm" type="submit"><i class="fa fa-edit"></i> ویرایش</button>
