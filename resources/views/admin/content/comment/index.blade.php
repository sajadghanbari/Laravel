    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 borderd-bottom pb-2" >
                <a href="#" class="btn btn-info btn-sm disabled">ایجاد دسته بندی</a>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.content.comment.show')}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> نمایش</a>
