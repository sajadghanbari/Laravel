...
class TicketPriorityController extends Controller
{
    ...
    public function store(TicketPriorityRequest $request)
    {
        ...
        return redirect()->route('admin.ticket.priority2.index')->with('swal-success', 'اولویت  جدید شما با موفقیت ثبت شد');
    }
    ...
    public function update(TicketPriorityRequest $request, TicketPriority $ticketPriority)
    {
        ...
        return redirect()->route('admin.ticket.priority2.index')->with('swal-success', 'اولویت شما با موفقیت ویرایش شد');
    }
    ...
    public function destroy(TicketPriority $ticketPriority)
    {
        ...
        return redirect()->route('admin.ticket.priority2.index')->with('swal-success', 'اولویت شما با موفقیت حذف شد');
    }
