...
class PropertyController extends Controller
{
    ...
    {
        $inputs = $request->all();
        $atrribute = CategoryAttribute::create($inputs);
        return redirect()->route('admin.market.property.index')->with('swal-success', 'برند جدید شما با موفقیت ثبت شد');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ProductRequest $request, CategoryAttribute $categoryAttribute)
    {
        $inputs = $request->all();
        $categoryAttribute = CategoryAttribute::update($inputs);
