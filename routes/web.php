...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('ticket')->namespace('Ticket')->group(function () {
        ...
        //priority
        Route::prefix('priority2')->group(function () {
            Route::get('/', [TicketPriorityController::class, 'index'])->name('admin.ticket.priority2.index');
            Route::get('/create', [TicketPriorityController::class, 'create'])->name('admin.ticket.priority2.create');
            Route::post('/store', [TicketPriorityController::class, 'store'])->name('admin.ticket.priority2.store');
            Route::get('/edit/{ticketPriority}', [TicketPriorityController::class, 'edit'])->name('admin.ticket.priority2.edit');
            Route::put('/update/{ticketPriority}', [TicketPriorityController::class, 'update'])->name('admin.ticket.priority2.update');
            Route::delete('/destroy/{ticketPriority}', [TicketPriorityController::class, 'destroy'])->name('admin.ticket.priority2.destroy');
            Route::get('/status/{ticketPriority}', [TicketPriorityController::class, 'status'])->name('admin.ticket.priority2.status');
        });
    ...
    Route::prefix('setting')->namespace('Setting')->group(function () {
        ...
        Route::get('/show', [SettingController::class, 'show'])->name('admin.setting.show');
